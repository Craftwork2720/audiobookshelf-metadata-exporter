...
| `MATCHER_ENABLED` | `false` | Fuzzy matching of metadata against folder names — tuned for specific folder naming conventions, may not be useful for most setups (also toggleable in UI) |
